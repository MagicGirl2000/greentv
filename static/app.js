...
// ——— 多语言 i18n ———
const I18N = {
  zh: { rain: "🌦 降雨预测", sat: "🛰 卫星云图", ana: "🌐 各地验证", map: "🗺 世界地图", agr: "用户协议", dis: "免责声明", thx: "鸣谢", advice: "实时建议加载中…", chans: "频道维度（点击看K线）", live: "直播", down: "断连", demo: "演示", sIdx: "📊 指数（点击看K线）", sCidx: "🌍 各国（地区）指数", sCh: "📺 频道", sDown: "🔴 断连", total: "共", units: "台", cover: "覆盖", advTip: "💡 综合建议：", now: "当前", init: "初始", chg: "涨跌", dim: "维" },
  en: { rain: "🌦 Rain", sat: "🛰 Satellite", ana: "🌐 Verify", map: "🗺 World Map", agr: "Terms", dis: "Disclaimer", thx: "Thanks", advice: "Loading…", chans: "Channels (click for chart)", live: "Live", down: "Offline", demo: "Demo", sIdx: "📊 Indices (click for chart)", sCidx: "🌍 Country/Region Indices", sCh: "📺 Channels", sDown: "🔴 Offline", total: "Total", units: "", cover: "covers", advTip: "💡 Advice: ", now: "Now", init: "Init", chg: "Chg", dim: "D" },
  es: { rain: "🌦 Lluvia", sat: "🛰 Satélite", ana: "🌐 Verificar", map: "🗺 Mapa Mundial", agr: "Términos", dis: "Aviso", thx: "Gracias", advice: "Cargando…", chans: "Canales (clic para gráfico)", live: "En vivo", down: "Desconectado", demo: "Demo", sIdx: "📊 Índices (clic)", sCidx: "🌍 Índices por país/región", sCh: "📺 Canales", sDown: "🔴 Desconectado", total: "Total", units: "", cover: "cubre", advTip: "💡 Consejo: ", now: "Ahora", init: "Inicial", chg: "Cambio", dim: "D" },
  fr: { rain: "🌦 Pluie", sat: "🛰 Satellite", ana: "🌐 Vérifier", map: "🗺 Carte du Monde", agr: "Conditions", dis: "Avertissement", thx: "Merci", advice: "Chargement…", chans: "Chaînes (clic pour graphique)", live: "En direct", down: "Hors ligne", demo: "Démo", sIdx: "📊 Indices (clic)", sCidx: "🌍 Indices par pays/région", sCh: "📺 Chaînes", sDown: "🔴 Hors ligne", total: "Total", units: "", cover: "couvre", advTip: "💡 Conseil : ", now: "Actuel", init: "Init", chg: "Var", dim: "D" },
  de: { rain: "🌦 Regen", sat: "🛰 Satellit", ana: "🌐 Prüfen", map: "🗺 Weltkarte", agr: "Bedingungen", dis: "Haftung", thx: "Danke", advice: "Lädt…", chans: "Kanäle (Klick für Chart)", live: "Live", down: "Offline", demo: "Demo", sIdx: "📊 Indizes (Klick)", sCidx: "🌍 Länder-/Regionalindizes", sCh: "📺 Kanäle", sDown: "🔴 Offline", total: "Gesamt", units: "", cover: "deckt", advTip: "💡 Hinweis: ", now: "Jetzt", init: "Init", chg: "Änd", dim: "D" },
  ar: { rain: "🌦 المطر", sat: "🛰 قمر", ana: "🌐 تحقق", map: "🗺 خريطة العالم", agr: "الشروط", dis: "إخلاء", thx: "شكر", advice: "جارٍ التحميل…", chans: "القنوات (انقر للرسم)", live: "مباشر", down: "غير متصل", demo: "تجريبي", sIdx: "📊 المؤشرات (انقر)", sCidx: "🌍 مؤشرات الدول/المناطق", sCh: "📺 القنوات", sDown: "🔴 غير متصل", total: "المجموع", units: "", cover: "يغطي", advTip: "💡 نصيحة: ", now: "الآن", init: "بداية", chg: "تغير", dim: "" },
};
let curLang = "zh";
